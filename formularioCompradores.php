...
<head>
  ...
  <link rel="stylesheet" href="./fondoCompradores.css">
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="sinRegistrarPaginaPrincipal.php">Imperfect Food</a>
    </div>
  </nav>
  ...
  <section class="fondoCompradores">
    <div class="container">
        ...
        <form action="registrarVendedores.php" method="post" enctype="multipart/form-data" class="needs-validation"
            ...
            <div class="col-lg-5" style=" border-radius: 10px; box-shadow: 10px 10px 10px -6px black;">
  ...
  <script src="confirmacionContraseña.js"></script>
  <script src="paraElOjoConfirmar.js"></script>
