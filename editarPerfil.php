<?php
     ...
     require 'conexion.php';
      ...
      session_start();
      $emai = $_SESSION['email1'];
      $pas = $_SESSION['pass1'];

      $result = pg_query($conexion,"SELECT usuarios.nombre,email,contrasenia,telefono,ubicacion,descripcion FROM usuarios WHERE usuarios.email = '$emai' and contrasenia = '$pas'");
                        ...
                        <div class="col-lg-5">
                          ...
                          <div class="col">
                              <label for="NombreNegocio" class="form-label">Nombre de Negocio:</label>
                               <input type="text" value= "<?php echo $row['nombre'];?>" name="NombreNegocio" id="NombreNegocio"class="form-control" pattern = "^[A-Z|a-z|0-9|`|&|.|\s|!|-|,]{3,20}$" required>
